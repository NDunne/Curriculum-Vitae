...
C++ 17       & Python       & Git          & Linux/UNIX    & Vim              & gdb\\[1pt]
\skillbox{8} & \skillbox{8} & \skillbox{9} & \skillbox{8}  & \skillbox{8}     & \skillbox{6}\\[6pt]
C            & Bash         & Perforce     & Windows       & Visual Studio    & WinDBG \\
\skillbox{8} & \skillbox{8} & \skillbox{2} & \skillbox{7}  & \skillbox{6}     & \skillbox{5}\\[6pt]
Java         & PowerShell   &              &               & Microsoft Office & SysInternals \\
\skillbox{5} & \skillbox{7} &              &               & \skillbox{8}     & \skillbox{6}\\[6pt]
AArch64      & Lua          &              &               & LateX/BibTeX     & \\
\skillbox{3} & \skillbox{2} &              &               & \skillbox{6}     & \\
   \end{tabularx}
