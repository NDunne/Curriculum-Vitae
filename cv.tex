...
{
  \ghost{post} & \\
  \result{grad}{2}{Graduate: First Class}{1st (72\%)}{July 2020}{University of Warwick}{Dissertation: Just-In-Time Compilation for an Unstructed Mesh DSL (77\%)} & \\
  \ghost{uni3} & \result{3rdYr}{2}{Third Year}{1st (73\%)}{June 2020}{University of Warwick}{Compiler Design (81\%), Fault-Tolerabt Systems (77\%), Computer Graphics (75\%)}\\
  \ghost{uni2.5} & \result{int}{2}{Intercalated Year}{}{2019}{Sophos Ltd \& Arm Ltd}{}\\
